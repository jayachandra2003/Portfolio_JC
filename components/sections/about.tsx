  ...
  return (
    <section id="about" className="scroll-mt-20 mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 md:pt-24 md:pb-12 lg:px-8">
      ...
      <motion.div
        ...
        className="mb-8 lg:mb-10 lg:-translate-x-9 xl:-translate-x-14"
      >
      ...
      <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-12 lg:gap-10 xl:gap-12">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-40px" }}
          transition={{ duration: 0.5 }}
          className="flex flex-col gap-6 lg:col-span-7 xl:col-span-7 lg:-translate-x-9 xl:-translate-x-14"
        >
