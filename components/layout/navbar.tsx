  ...
  return (
    <header className="sticky top-0 z-50 w-full liquid-glass border-b border-white/10 transition-colors duration-300">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 sm:px-8 lg:px-10">
        <Link href="/#home" className="font-display text-xl sm:text-[1.45rem] italic text-foreground transition-colors hover:text-accent">
          Jaya Chandra
        </Link>
            ...
            return (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className={cn(
                    "font-body text-sm sm:text-[15px] font-medium transition-colors hover:text-accent",
